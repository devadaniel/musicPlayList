...
class SongsPlayList extends Component {
  ...
  render() {
    ...
    const searchPlayList = playList.filter(eachItem =>
    ...
    return (
      <div className="main-container">
        <div className="banner-container">
          ...
          <p className="banner-singer">Singer</p>
        </div>
        <div className="songs-paly-list-container">
          <div className="songs-heading-search-box-container">
          ...
          {searchPlayList.length === 0 ? (
            ...
            <ul className="song-play-items">
              {searchPlayList.map(eachItem => (
                <SongPlayItem
                  key={eachItem.id}
                  songItem={eachItem}
                  onClickDeletePlayItem={this.onClickDeletePlayItem}
                />
              ))}
            </ul>
          )}
